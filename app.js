...
function renderResult(result) {
  ...
  switch (result) {
    case "tie":
      ...
      p.setAttribute("style", "font-family: BloodType; font-size: 12vw; color: red; text-decoration: none")
      break
    case "win":
      p.innerHTML = "YOU WIN!!!"
      p.setAttribute("style", "font-family: RubberStamp; color: green; transform: rotate(-5deg)")
      break
    case "lose":
      p.innerHTML = "YOU LOSE!"
      p.setAttribute("style", "font-family: RubberStamp; color: red; transform: rotate(5deg)")
  }
